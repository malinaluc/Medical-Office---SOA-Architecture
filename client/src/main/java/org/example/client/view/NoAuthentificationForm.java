...
import org.example.client.controller.NoAuthentificationController;
...
public class NoAuthentificationForm {
    ...
    private NoAuthentificationController noAuthentificationController;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    public NoAuthentificationForm() {

        noAuthentificationController = new NoAuthentificationController(this);
        languageSetter();

    }

    public void languageSetter() {
        this.vizualizareSpecializariButton.setText(LanguageManager.getString("vizualizareSpecializariButton"));
        this.vizualizareListaMediciButton.setText(LanguageManager.getString("vizualizareListaMediciButton"));
        this.afisareInfoMedicButton.setText(LanguageManager.getString("afisareInfoMedicButton"));
        this.vizualizareInfoMedicButton.setText(LanguageManager.getString("vizualizareInfoMedicButton"));
        this.goBackButton.setText(LanguageManager.getString("goBackButton"));
        this.vizualizareSpecializariLabel.setText(LanguageManager.getString("vizualizareSpecializariLabel"));
        this.vizualizareMediciLabel.setText(LanguageManager.getString("vizualizareMediciLabel"));
        this.informatiiMedicLabel.setText(LanguageManager.getString("informatiiMedicLabel"));
        this.numeMedicLabel.setText(LanguageManager.getString("numeMedicLabel"));
    }
