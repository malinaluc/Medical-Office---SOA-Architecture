...
public interface ConsultationRepository extends JpaRepository<Consultation, Integer> {
    ...
    @Query("select new Consultation(c.idConsultation,c.startConsultationHour,c.endConsultationHour,c.namePatient,c.idMedic) from Consultation c where c.namePatient = :patientName")
    List<Consultation> allConsultationByPatientName(String patientName);
